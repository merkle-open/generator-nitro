...
app.set('views', config.get('nitro.basePath') + config.get('nitro.viewDirectory'));<% if (options.templateEngine === 'twig') { %>
app.engine(config.get('nitro.viewFileExtension'), twig.renderWithLayout);<% } else { %>
